            ...
            introJs().setOptions({
                steps: [
                    ...
                    },
                    {
                        ...
                        intro: 'Please Enter your desired Date of Retirement'
                    },
                    {
...
<h2 class="card-title text-2xl font-bold mb-2">Calculate Years in Service - OPT</h2>
...
<div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6 bg-base-200 p-6 rounded-2xl">
    ...
    <div class="form-control w-full md:col-span-2">
        <label for="dor" class="label font-semibold"><span class="label-text">Desired Date of Retirement</span></label> 
        <input id="dor" type="date" class="input input-bordered w-full bg-base-100" bind:value={retdate} onchange={()=>{getYearsInService();getAgeValidation();counterGovService();addOtherSvc();errorHandler();}}>
    </div>
</div>
