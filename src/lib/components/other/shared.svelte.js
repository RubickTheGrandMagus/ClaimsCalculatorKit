export const YearsInSvc = $state({
    dob:"",des:"",dos:"",total:{y:0,m:0,d:0},allService:{suspension:{state:false,years:0,months:0,days:0},bfp:{years:0,months:0,days:0}},error:{state:false,text:""},isNUP:false
});
